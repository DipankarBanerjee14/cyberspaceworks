      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row justify-around gap-10 flex-wrap">
        ...
        <div className="w-full md:w-[180px] text-center lg:text-left">
          ...
          <ul className="space-y-2 text-gray-300">
            ...
            <li><Link href="" className="hover:text-white transition">Research and Analytics</Link></li>
          </ul>
        </div>
        ...
        <div className="w-full md:w-[220px] text-center lg:text-left">
          ...
          <div className="mt-4 space-y-2">
            <p><span className="text-gray-300">+91 7980715765</span></p>
            <p><span className="text-gray-300">cyberspaceworksofficial@gmsil.com</span></p>
